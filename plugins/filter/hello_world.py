"""A hello-world filter plugin in my_new_collection_namespace_05.my_new_collection_name_05."""
...
DOCUMENTATION = """
    name: hello_world
    author: My_new_collection_namespace_05 My_new_collection_name_05
    version_added: "1.0.0"
